...
// Route::get('getIP',[ProductController::class,'getIP']);
...
Route::group(['middleware' => ['auth:api', 'superadmin'] , 'prefix' => 'superadmin'], function () {
...
Route::group(['middleware' => 'auth:api' , 'perfix' => 'admin'], function () {
